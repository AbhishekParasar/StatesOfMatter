...
public class AdvancedParticleSimulationW : MonoBehaviour
{
    ...
    public TemperatureManagerW temperatureManager;
    ...
    public float argonMeltingPoint = 0f; // °C
    public float argonBoilingPoint = 100f; // °C
    ...
    [SerializeField] AssessmentUnlocker assessmentUnlocker;
    ...
    void UpdateButtons()
    {
        ...
        if (isLiquidStateDone && isGasStateDone && isSolidStateDone == true)
        {
            ...
            if (!tickImageState.gameObject.activeSelf)
            {
                ...
                if (assessmentUnlocker != null)
                {
                    assessmentUnlocker.CheckAllActivitiesComplete();
                }
            }
        }
    }
