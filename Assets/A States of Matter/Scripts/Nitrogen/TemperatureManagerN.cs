...
public class TemperatureManagerN : MonoBehaviour
{
    public Button increaseTemperature, decreaseTemperature;
    private AdvancedParticleSimulationN advancedParticleSimulation;
    public Image thermostatfillimage;

    public bool isIncreasing = false;
    public bool isDecreasing = false;
   [SerializeField] private float tempChangeSpeed = 10f; // Speed at which the temperature changes per second

    private void Awake()
    {

        tempChangeSpeed = 1f;
        advancedParticleSimulation = FindAnyObjectByType<AdvancedParticleSimulationN>();
    ...
    {
        // Clamp temperature within the nitrogen simulation range
        advancedParticleSimulation.temperature = Mathf.Clamp(
            advancedParticleSimulation.temperature,
            -220f, // Minimum temperature for nitrogen simulation
            -185f  // Maximum temperature for nitrogen simulation
        );
        ...
        float normalizedTemperature = (roundedTemperature - (-210f)) / (-196f - (-210f)); // Normalize temperature to 0-1 range
    ...
    public void SetSolidMode()
    {
        ...
        advancedParticleSimulation.UpdateStateByTemperature();
        advancedParticleSimulation.temperature = -212f;
        UpdateTemperatureUI();
    }
    ...
    public void SetLiquidMode()
    {
        ...
        advancedParticleSimulation.currentState = AdvancedParticleSimulationN.State.Liquid;
        advancedParticleSimulation.temperature = -210f;
        UpdateTemperatureUI();
    }   
    ...
    public void SetGasMode()
    {
        ...
        advancedParticleSimulation.currentState = AdvancedParticleSimulationN.State.Gas;
        advancedParticleSimulation.temperature = -196f;
        UpdateTemperatureUI();
    }
}
