...
public class AdvancedParticleSimulationN : MonoBehaviour
{
    ...
    public TMP_Text tempTemperatureLabel;
    ...
    public TemperatureManagerN temperatureManager;
    ...
    public float argonMeltingPoint = -210f; // °C
    public float argonBoilingPoint = -195f; // °C
    ...
    public void UpdateStateByTemperature()
    {
        ...
        else if (temperature >= argonMeltingPoint && temperature < argonMeltingPoint+1.0f) // Between melting and boiling point -> Liquid
        {
    ...
    void UpdateButtons()
    {
        ...
        if (isLiquidStateDone && isGasStateDone && isSolidStateDone == true)
        {
