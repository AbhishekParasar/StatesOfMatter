...
public class AdvancedParticleSimulationO : MonoBehaviour
{
    ...
    public TemperatureManagerO temperatureManager;
    ...
    public float argonMeltingPoint = -218f; // °C
    public float argonBoilingPoint = -183f; // °C
    ...
    [SerializeField] float gasTemprature = -183f;
    public void UpdateStateByTemperature()
    {
        ...
        else if (temperature > (gasTemprature-1) && temperature <= (gasTemprature))
        {
       ...
       // else // Above boiling point -> Gas
         else if (temperature >= gasTemprature)// Above boiling point -> Gas
        {
            isGasStateDone = true;
    ...
    void UpdateButtons()
    {
        ...
        if (isLiquidStateDone && isGasStateDone  == true)
        {
